...
INPUT_TSV = Path(r"yourinputpathhere\example.tsv")
OUTPUT_CSV = Path(r"youroutputpathhere\example.csv")
...
#"col:rank":   ["other","proles","mutatio","lusus","abberation","forma specialis","subform","infrasubspecific name","infraspecific name","species aggregate","subsection zoology","section zoology","subsection botany","section botany","infrageneric name"]
#up2butnotincluding species:     
#"col:rank":   ["subspecies","variety","subvariety","form","other","proles","mutatio","lusus","abberation","forma specialis","subform","infrasubspecific name","infraspecific name","species aggregate","subsection zoology","section zoology","subsection botany","section botany","infrageneric name"]
#up2butnotincluding genus:       
#"col:rank":   ["subgenus","series","species","subspecies","variety","subvariety","form","other","proles","mutatio","lusus","abberation","forma specialis","subform","infrasubspecific name","infraspecific name","species aggregate","subsection zoology","section zoology","subsection botany","section botany","infrageneric name"]
#up2butnotincluding tribe:       
#"col:rank":   ["subtribe","infratribe","genus","subgenus","series","species","subspecies","variety","subvariety","form","other","proles","mutatio","lusus","abberation","forma specialis","subform","infrasubspecific name","infraspecific name","species aggregate","subsection zoology","section zoology","subsection botany","section botany","infrageneric name"]
#up2butnotincluding family:      
#"col:rank":   ["subfamily","infrafamily","supertribe","tribe","subtribe","infratribe","genus","subgenus","series","species","subspecies","variety","subvariety","form","other","proles","mutatio","lusus","abberation","forma specialis","subform","infrasubspecific name","infraspecific name","species aggregate","subsection zoology","section zoology","subsection botany","section botany","infrageneric name"]
...
#"col:rank":   ["species","subspecies","variety","subvariety","form","other","proles","mutatio","lusus","abberation","forma specialis","subform","infrasubspecific name","infraspecific name","species aggregate","subsection zoology","section zoology","subsection botany","section botany","infrageneric name"]
#up2butandincluding genus:       
#"col:rank":   ["genus","subgenus","series","species","subspecies","variety","subvariety","form","other","proles","mutatio","lusus","abberation","forma specialis","subform","infrasubspecific name","infraspecific name","species aggregate","subsection zoology","section zoology","subsection botany","section botany","infrageneric name"]
